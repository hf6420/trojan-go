...
#docker run --name trojan --restart unless-stopped --network=host -v /root/trojan/config.json:/etc/trojan-go/config.json -v /etc/letsencrypt:/etc/letsencrypt -v /usr/share/zoneinfo/Asia/Shanghai:/etc/localtime -d trojan
